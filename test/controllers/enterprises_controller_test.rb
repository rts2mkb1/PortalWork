...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { name: @enterprise.name, number: @enterprise.number, priority: @enterprise.priority }
    end
  ...
  test "should update enterprise" do
    patch :update, id: @enterprise, enterprise: { name: @enterprise.name, number: @enterprise.number, priority: @enterprise.priority }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end
