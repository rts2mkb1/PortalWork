...
class NewspapersControllerTest < ActionController::TestCase
  ...
  test "should create newspaper" do
    assert_difference('Newspaper.count') do
      post :create, newspaper: { number: @newspaper.number, relese_date: @newspaper.relese_date, year: @newspaper.year }
    end
  ...
  test "should update newspaper" do
    patch :update, id: @newspaper, newspaper: { number: @newspaper.number, relese_date: @newspaper.relese_date, year: @newspaper.year }
    assert_redirected_to newspaper_path(assigns(:newspaper))
  end
